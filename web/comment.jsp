    ...
    <section class="section-category">
        <div class="b-page-header">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 clearfix">
                        <h3 class="page-title pull-left">课程讨论</h3>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-lg-9">
                    <div class="heading-line" style="font-size: 200%">讨论与提问</div>
                    <iframe src="cooment.jsp" align="center"  width="500px" height="1055px" scrolling="no" class="maxvideosize"></iframe>
                </div>
            </div>
        </div>
    </section>
