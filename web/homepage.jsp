<%@ page import="com.LoginCheck.Bean.User" %>
                ...
                <div class="sp-slides">
                    <div class="sp-slide">
                        ...
                        <div class="sp-layer slide-tex-1"
                            ...
                            <span>Instructions<br><span class="border-line">on line</span></span>
                        </div>
                        ...
                        <div class="sp-layer"
                            ...
                            <a class="btn btn-primary-color1 btn-sm" href="#">CLICK NOW</a>
                        </div>
                    </div>
                    ...
                    <div class="sp-slide">
                        ...
                        <div class="sp-layer"
                             ...
                             data-show-transition="left" data-hide-transition="up" data-show-delay="1000">
                            <button class="btn btn-default-color1 btn-sm" type="button">CLICK NOW</button>
                        </div>
                    </div>
                    ...
                    <div class="sp-slide">
                        ...
                        <div class="sp-layer s3-discount"
                             ...
                             data-show-transition="left" data-hide-transition="up" data-show-delay="800">
                            <span>instructions<br>10% UP</span>
                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <a href="#" class="wow fadeInLeft">
                            <img src="picture/R语言基础.jpg" class="img-responsive center-block" alt="/">
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <a href="#">
                            <img src="picture/Scala程序设计—基础篇.jpg" class="img-responsive center-block" alt="/">
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <a href="#" class="wow fadeInRight">
                            <img src="picture/云安全的架构设计与实践之旅.jpg" class="img-responsive center-block" alt="/">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a class="heading-line-long" href="homepage.action#bybrand" aria-controls="bybrand" role="tab" data-toggle="tab">为您推荐</a>
                            </li>
                        </ul>
                                        ...
                                        <div class="b-brand-filters">
                                            <div>
                                                <ul class="tags-buttons list-inline by-brands-buttons">
                                                    ...
                                                    <li>
                                                        <button data-filter=".microsoft" class="btn btn-tag">微专业</button>
                                                    </li>
                                                    <li>
                                                        <button data-filter=".htc" class="btn btn-tag">产品和设计</button>
                                                    </li>
                                                    <li>
                                                        <button data-filter=".sony" class="btn btn-tag">办公效率</button>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <button data-filter=".oppo" class="btn btn-tag">职业发展</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <s:iterator value="courses" status="status">
                                            <div class="related-item col-xs-6 col-sm-6 col-md-3 col-lg-3">
                                                <div class="b-item-card">
                                                    ...
                                                    <div class="image">
                                                        <a href="#">
                                                            <img src="<s:property value="source"/> " class="img-responsive center-block" alt="/">
                                                        </a>
                                                    ...
                                                    <div class="card-info">
                                                        <div class="caption">
                                                            <a class="product-price"  href="detailsAction.action?source=<s:property value="source"></s:property>"><s:property value="name"></s:property> </a>
                                                            <p class="name-item">
                                                                <span class="product-name"><s:property value="key"></s:property> </span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
